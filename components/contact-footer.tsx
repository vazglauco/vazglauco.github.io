...
export function ContactFooter() {
  ...
  return (
    <section
      ref={sectionRef}
      id="contato"
      className="relative bg-[#0a0a0a] text-white min-h-screen flex flex-col justify-between"
    >
      {/* Main content */}
      <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-24">
        ...
        >
          <h2 className="text-[3rem] md:text-[5rem] lg:text-[7rem] xl:text-[9rem] font-black tracking-tight leading-[0.85] text-white uppercase">
            VAMOS
            <br />
        ...
        <div className="flex items-stretch gap-8 lg:gap-16">
          ...
          <a
            ...
            className="group flex items-center justify-between py-6 border-b border-neutral-800 hover:border-amber-800/40 transition-colors"
          >
            <div className="flex items-center gap-4 md:gap-6">
              <Mail className="w-5 h-5 text-neutral-600 group-hover:text-amber-500 transition-colors" />
            ...
            <span className="text-xs font-mono text-neutral-600 tracking-wider uppercase hidden sm:block">
              Email
            </span>
          </a>
          ...
          <a
            ...
            className="group flex items-center justify-between py-6 border-b border-neutral-800 hover:border-green-800/40 transition-colors"
          >
            <div className="flex items-center gap-4 md:gap-6">
              <MessageCircle className="w-5 h-5 text-neutral-600 group-hover:text-green-500 transition-colors" />
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-between py-6 border-b border-neutral-800 hover:border-blue-800/40 transition-colors"
          >
            <div className="flex items-center gap-4 md:gap-6">
              <Linkedin className="w-5 h-5 text-neutral-600 group-hover:text-blue-500 transition-colors" />
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-between py-6 border-b border-neutral-800 hover:border-neutral-600 transition-colors"
          >
            <div className="flex items-center gap-4 md:gap-6">
          ...
          >
            <div className="flex items-center gap-4 md:gap-6">
              <Download className="w-5 h-5 text-neutral-600 group-hover:text-amber-500 transition-colors" />
              <span className="text-lg md:text-2xl font-bold tracking-tight group-hover:text-amber-100 transition-colors">
                Download Currículo
              </span>
            </div>
      ...
      {/* Footer */}
      <div className="px-8 md:px-16 lg:px-24 py-8 border-t border-neutral-900 flex items-center justify-between">
        ...
        <button
          ...
          className="group flex items-center gap-2 text-xs font-mono text-neutral-600 hover:text-amber-500 transition-colors"
        >
          Voltar ao topo
